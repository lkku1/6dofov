...
import core
from core.trainer_color import Trainer
from core.trainer_depth import Trainer
...
parser = argparse.ArgumentParser(description='3DMPV')
parser.add_argument('-c',
                    '--config',
                    default='configs/3DMPV_depth.json',
                    type=str)
